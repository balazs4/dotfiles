...
call <sid>hi('NonText',        s:gui03, 'none', s:cterm03, 'none', '', '')
...
call <sid>hi("Visual",         s:gui00, s:gui09, s:cterm00, s:cterm09, '', '')
...
if has('nvim-0.8.0')
  ...
  call <sid>hi('@module.builtin',             s:gui05, '', s:cterm05, '', '', '')
  hi! link @label Tag
  ...
  call <sid>hi('@string.special.path',        s:gui0D, '', s:cterm0D, '', '', '')
  call <sid>hi('@string.special.url',         s:gui08, '', s:cterm08, '', '', '')
  ...
  hi! link @type Type
  call <sid>hi('@type.builtin',               s:gui0A, '', s:cterm0A, '', '', '')
  hi! link @type.definition Typedef

  hi! link @attribute Special
  call <sid>hi('@attribute.builtin',          s:gui0C, '', s:cterm0C, '', '', '')
  hi! link @property @variable.member

  call <sid>hi('@function',                   s:gui16, '', s:cterm16, '', '', '')
  call <sid>hi('@function.builtin',           s:gui16, '', s:cterm16, '', '', '')
  ...
  call <sid>hi('@comment.note',    s:gui0D, '', s:cterm0D, '', '', '')
  call <sid>hi('@comment.todo',    s:gui0C, '', s:cterm0C, '', '', '')
  ...
  hi! link @tag                 Tag
  call <sid>hi('@tag.builtin',  s:gui09, '', s:cterm09, '', '', '')
  ...
  call <sid>hi('@lsp.mod.defaultLibrary',    '', '', '', '', '', '')
...
call <sid>hi('htmlItalic', s:gui05, '', s:cterm17, '', '', '')
...
call <sid>hi('NeogitDiffContext',           s:gui03, '', s:cterm03, '', '', '')
...
call <sid>hi('NeogitDiffContextHighlight',  s:gui03, s:guibg, s:cterm03, s:ctermbg, '', '')
call <sid>hi('NeogitDiffContextCursor',     '', s:guibg, "", s:ctermbg, '', '')
