...
vim.api.nvim_set_hl(0, 'Comment', { fg = '#{{base03-hex}}', bg = '#{{base00-hex}}' })
...
vim.api.nvim_set_hl(0, 'Keyword', { fg = '#{{base07-hex}}' })
...
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = '#{{base06-hex}}' })
...
vim.api.nvim_set_hl(0, 'TSAnnotation', { fg = '#{{base08-hex}}' })
...
vim.api.nvim_set_hl(0, 'Todo', { fg = '#{{base08-hex}}' })
